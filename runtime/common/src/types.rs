...
pub type GovernanceOrigin<AccountId, Runtime> = frame_support::traits::EnsureOneOf<
...
impl<T: frame_system::Config> pallet_committee::traits::VotingPeriodRange<T::BlockNumber>
    for VotingPeriodRange<T>
{
